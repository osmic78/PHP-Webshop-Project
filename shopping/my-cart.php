...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php " ".$row['productPrice']; ?>.00 KM</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo " ".$row['shippingCharge']; ?>.00 KM</span></td>
